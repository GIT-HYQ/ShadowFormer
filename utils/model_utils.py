...
def get_arch(opt):
    ...
    elif arch == 'ShadowFormer_anm':
        model_restoration = ShadowFormer(img_size=opt.train_ps,embed_dim=opt.embed_dim,win_size=opt.win_size,token_projection=opt.token_projection,token_mlp=opt.token_mlp, anm=True)
    else:
